  ...
  <div class="container">
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
        <div class="col-lg-5 d-none d-lg-block" style="background-image: url('https://2.bp.blogspot.com/-1tZua2AIH3M/XFKkApFDDkI/AAAAAAAADfU/wIpUSJPBKXYc4GfREMZf2YNuZI42MbBfgCLcBGAs/s1600/Komoditas%2BPertanian%2Byang%2BBerpotensi%2BDiekspor.jpg'); background-size: cover;"></div>
          <div class="col-lg-7">
            <div class="p-5">
